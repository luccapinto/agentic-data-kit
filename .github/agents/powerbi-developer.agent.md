---
description: Power BI as-code developer. Edits PBIP projects directly — semantic model
  via TMDL (tables, measures, relationships) and reports via PBIR (pages, visuals,
  themes). Validates with Tabular Editor 2 (free). Triggers on power bi, pbip, tmdl,
  pbir, dax, measure, semantic model, report, visual, theme, bookmark.
