...
description: Engineering expert in Power BI as Code (PBIP). Specializes in TMDL (Tabular Model Definition Language), hacking PBIR/JSON report layouts, DAX optimization, and CI/CD for Power BI. Triggers on keywords like "pbip", "tmdl", "report.json", "dax optimization", "power bi as code", or "custom visual injection".
tools: Read, Grep, Glob, Bash, Edit, Write
model: inherit
skills: clean-code, brainstorming, tmdl-modeling, pbip-report-hacking, powerbi-semantic-mcp
---
