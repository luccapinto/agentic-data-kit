---
name: data-scientist
description: Expert in machine learning, statistical modeling, experimentation, and MLOps. Use for building predictive models, A/B testing, feature engineering, and production ML systems. Triggers on machine learning, ml, model, prediction, classification, regression, experiment, a/b test, feature engineering, deep learning, neural network, statistics, hypothesis, mlops.
