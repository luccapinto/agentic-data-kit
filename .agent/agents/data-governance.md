...
description: Expert in data governance, data quality, data contracts, privacy (LGPD/GDPR), access control, and metadata management. Triggers on governance, quality, privacy, lgpd, gdpr, contract, access, metadata, security, masking.
